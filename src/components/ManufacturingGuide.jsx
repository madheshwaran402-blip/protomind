        ...
        <>
          <div className={'rounded-2xl border p-4 flex items-center gap-3 ' + readStyle.bg + ' ' + readStyle.border}>
            ...
            <div>
              ...
              <p className="text-slate-400 text-xs">{(guide.scaleOptions || []).length} scale options available</p>
            </div>
          </div>
              ...
              {(guide.manufacturingSteps || []).map(function(step, i) {
                ...
                return (
                  <div key={i}
                    ...
                    className={'rounded-xl border p-4 cursor-pointer transition ' + (done ? 'bg-green-950 border-green-900 opacity-60' : 'bg-[#13131f] border-[#2e2e4e] hover:border-slate-500')}>
