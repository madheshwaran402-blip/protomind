...
export function checkAndUnlockAchievements(projects, versions) {
  const newlyUnlocked = []
  if (projects.length >= 1) { const a = unlockAchievement('first_prototype'); if (a) newlyUnlocked.push(a) }
  if (projects.length >= 5) { const a = unlockAchievement('five_prototypes'); if (a) newlyUnlocked.push(a) }
  if (projects.length >= 10) { const a = unlockAchievement('ten_prototypes'); if (a) newlyUnlocked.push(a) }
  if (versions.length >= 1) { const a = unlockAchievement('first_save'); if (a) newlyUnlocked.push(a) }
